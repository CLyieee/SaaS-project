document.addEventListener("DOMContentLoaded",function(e){let s,a,r,n=(s=config.colors.borderColor,a=config.colors.bodyBg,r=config.colors.headingColor,document.querySelector(".datatables-order")),o={1:{title:"Dispatched",class:"bg-label-warning"},2:{title:"Delivered",class:"bg-label-success"},3:{title:"Out for Delivery",class:"bg-label-primary"},4:{title:"Ready to Pickup",class:"bg-label-info"}},l={1:{title:"Paid",class:"text-success"},2:{title:"Pending",class:"text-warning"},3:{title:"Failed",class:"text-danger"},4:{title:"Cancelled",class:"text-secondary"}};if(n){let t=new DataTable(n,{ajax:assetsPath+"/order-list.json",columns:[{data:"id"},{data:"id",orderable:!1,render:DataTable.render.select()},{data:"order"},{data:"date"},{data:"customer"},{data:"payment"},{data:"status"},{data:"method"},{data:"id"}],columnDefs:[{className:"control",searchable:!1,orderable:!1,responsivePriority:2,targets:0,render:function(e,t,s,a){return""}},{targets:1,orderable:!1,searchable:!1,responsivePriority:3,checkboxes:!0,checkboxes:{selectAllRender:'<input type="checkbox" class="form-check-input">'},render:function(){return'<input type="checkbox" class="dt-checkboxes form-check-input">'}},{targets:2,render:function(e,t,s,a){return'<a href="app-ecommerce-order-details.html"><span>#'+s.order+"</span></a>"}},{targets:3,render:function(e,t,s,a){var r=new Date(s.date),s=s.time.substring(0,5);return`<span class="text-nowrap">${r.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})}, ${s}</span>`}},{targets:4,responsivePriority:1,render:function(e,t,s,a){var r=s.customer,n=s.email,s=s.avatar;let o;return`
              ...
              </div>`}},{targets:5,render:function(e,t,s,a){const payment = s.payment;const paymentObj = l[payment];return paymentObj ? `
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                ${Object.entries(l).map(([key, value]) => `
                    <li><a class="dropdown-item payment-status-item" 
                          data-payment-id="${key}" 
                          data-row-id="${s.id}">
                        <span class="${value.class}">
                            <i class="icon-base ti tabler-circle-filled icon-12px me-1"></i>${value.title}
                        </span>
                    </a></li>
                `).join('')}
            </ul>
        </div>`:e}},{targets:-3,render:function(e,t,s,a){s=s.status,s=o[s];return s?`
                <span class="badge px-2 ${s.class} text-capitalized">
                  ${s.title}
                </span>`:e}},{targets:-2,render:function(e,t,s,a){var r=s.method;let n="paypal"===r?"@gmail.com":s.method_number;return`
...
t.on('click', '.payment-status-item', function(e) {
    ...
    // Here you can also add an API call to update the backend
    // Example:
    // fetch('/api/orders/update-payment', {
    //     method: 'POST',
    //     body: JSON.stringify({ orderId: rowId, paymentStatus: paymentId })
    // });
});